            ...
            <div className="px-6 pt-4">
                <ul className="flex flex-col space-y-2">
                    {props.translation.sidebar.buttons.map((element, idx) => (
                        <li onClick={(e)=>{props.handleChangePage(idx)}} key={idx} 
                            ...
                            <a  href="#" 
                                ...
                                hover:bg-gray-800 ${props.page==idx?'text-white outline-none ring-1 ring-gray-500 bg-gray-800':'focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800'}`}>
                                    {element}
                            </a>
                        </li>
                    ))}          
